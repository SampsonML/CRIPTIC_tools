...
Alfven = 0; Mach = 1; Ion = 2; DPar = 3; DPerp = 4; Epar = 5; Eperp = 6 ; AlphaPar = 7; AlphaPerp = 8
### Correct Scale units
...
y_limit_perp = [ylow*0.9,yhigh*20]
plt.text(chi_x, chi_y_par, r"$\chi = 1 $" , fontsize = chi_lab)
plt.ylabel(r'$D_{\perp}$ ($c^{\alpha} \cdot L \cdot c_s \cdot \mathcal{M}$)', fontsize = 34)
...
plt.legend(handles,labels, frameon=False,fontsize=leg_lab, ncol = 5, bbox_to_anchor=(0,1.00,1.0,0.2), loc="upper left")
plt.rc('font', **{'size':'24'})
plt.yscale('log')
plt.xscale('log')
plt.xlim(x_limit)
...
#########################################
#########################################
#plt.suptitle('Perpendicular')
plt.savefig('Perp_diff.png')
